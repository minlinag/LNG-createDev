...
export function postManagementFindAllList(params) {
  return request({
    url: '/PersonnelPostManage/findAllList',
    method: 'get',
    params
  })
}
...
export function postManagementInsert(data) {
  return request({
    url: '/PersonnelPostManage/insert',
    method: 'post',
    data
  })
}
...
export function postManagementQueryByID(params) {
  return request({
    url: '/PersonnelPostManage/queryByID',
    method: 'get',
    params
  })
}
...
export function postManagementUpdateMain(data) {
  return request({
    url: '/PersonnelPostManage/updateMain',
    method: 'post',
    data
  })
}
...
export function postManagementDeleteBatch(data) {
  return request({
    url: '/PersonnelPostManage/deleteBatch',
    method: 'delete',
    data
  })
}
