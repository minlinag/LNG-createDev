...
import BonuspointsDetails from "./BonuspointsDetails.vue";
...
const columns = [
  ...
  { title: "班组", ellipsis: true, dataIndex: "teamGroup" },
  ...
  { title: "班组加分", ellipsis: true, dataIndex: "teamGroupDeduct" },
  { title: "人员加分", ellipsis: true, dataIndex: "personalDeduct" },
...
export default {
  ...
  data() {
    return {
      ...
      searchInfo: {
        pageNum: 1,
        pageSize: 10,
        assessType: 2, //当传入1是为减分界面，当传入2是为加分界面
      },
      pagination: {
        current: 0,
        // defaultCurrent: 1,
  ...
  methods: {
    onOperationDateTimeChange(value, mode) {
      ...
      console.log("this.searchInfo.startMonth", this.searchInfo.startMonth);
