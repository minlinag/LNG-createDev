  ...
  methods: {
    ...
    getPdfUrl() {
      let param = {
        ...
        businessCode: "SIGN_FILE_JL_CCZCYB",
      };
    ...
    Csubmit() {
      ...
      this.surfaceForm.idNumber = idNumber;
      this.surfaceForm.detailList = this.tankWagonList;
    ...
    formDataFun() {
      ...
      formData.append("endCumulativeDate", this.surfaceForm.endCumulativeDate);
      formData.append("reportType", this.surfaceForm.reportType);
      formData.append("loadingNumber", this.surfaceForm.loadingNumber);
      formData.append("loadingT", this.surfaceForm.loadingT);
      formData.append("loadingNm", this.surfaceForm.loadingNm);
      formData.append(
        "yearCumulativeLoadingNumber",
        this.surfaceForm.yearCumulativeLoadingNumber
      );
      formData.append(
        "yearCumulativeLoadingT",
        this.surfaceForm.yearCumulativeLoadingT
      );
      formData.append(
        "yearCumulativeLoadingNm",
        this.surfaceForm.yearCumulativeLoadingNm
      );
      ...
      for (let index = 0; index < dateString.length; index++) {
        ...
        if (index < dateString.length - 1) {
          dayString +=
            ...
            "\xa0\xa0\xa0\xa0\xa0\xa0\xa0\xa0\xa0\xa0\xa0\xa0\xa0\xa0\xa0\xa0\xa0\xa0\xa0\xa0\xa0\xa0\xa0\xa0至\xa0\xa0\xa0\xa0\xa0\xa0\xa0\xa0\xa0\xa0\xa0\xa0\xa0\xa0\xa0\xa0\xa0\xa0\xa0\xa0\xa0\xa0\xa0\xa0";
        } else {
