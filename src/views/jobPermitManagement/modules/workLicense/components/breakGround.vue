    ...
    <a-layout>
      <a-layout-content>
        <div ref="print" class="print-content">
          <h2 style="text-align: center;font-weight: 900">动土作业许可证</h2>
          ...
          <a-descriptions align="center" size="small" bordered class="d">
            ...
            <a-descriptions-item label="作业地点" :span="2">
          ...
          <a-descriptions align="center" size="small" bordered class="d">
            ...
            /></a-descriptions-item>
            <a-descriptions-item label="作业条件初审及实施安全教育人">
              <img
                class="appImg"
                :src="
            ...
            <a-descriptions-item
              label="生产运营中心_负责人"
              :span="3"
              v-if="HistoryObj['生产运营中心_负责人']"
            >
              <p>{{ HistoryObj["生产运营中心_负责人"].opinion }}</p>
              <p style="text-align: right">
                负责人：<img
                  class="appImg"
                  :src="HistoryObj['生产运营中心_负责人'].signImg"
                  alt=""
                />
                {{ HistoryObj["生产运营中心_负责人"].executeTime }}
              </p>
            </a-descriptions-item>
            <a-descriptions-item
