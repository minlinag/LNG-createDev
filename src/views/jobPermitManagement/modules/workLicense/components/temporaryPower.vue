    ...
    <a-layout>
      <a-layout-content>
        <div ref="print"  class="print-content">
          <h2 style="text-align: center">临时用电许可证</h2>
          ...
          <a-descriptions align="center" size="small" bordered class="d">
            ...
            <a-descriptions-item label="作业地点"
              >{{ taskForm.baseInfo.workPlace }}
            </a-descriptions-item>
            <a-descriptions-item label="作业内容" :span="2">
              {{ taskForm.baseInfo.workContent }}
            </a-descriptions-item>
            <a-descriptions-item label="电源接入点及许可用电功率">
              {{
                taskForm.measuresForm
                  ? taskForm.measuresForm.accessPointAndPower
                  : ""
              }}
            </a-descriptions-item>
            <a-descriptions-item label="工作电压" :span="2">
              {{ taskForm.measuresForm ? taskForm.measuresForm.voltage : "" }}
            </a-descriptions-item>
            <a-descriptions-item label="用电设备名称及额定功率" :span="3">
              {{
                taskForm.measuresForm
                  ? taskForm.measuresForm.nameAndRatedPower
                  : ""
              }}
            </a-descriptions-item>
            <a-descriptions-item label="作业人（接临时线路人）">
              {{ taskForm.baseInfo.operator }}
            </a-descriptions-item>
            <a-descriptions-item label="电工证号" :span="2">
              {{ taskForm.baseInfo.operatorElectricCertificate }}
            </a-descriptions-item>
            <a-descriptions-item label="作业负责人">
              {{ taskForm.baseInfo.personInCharge }}
            </a-descriptions-item>
            <a-descriptions-item label="电工证号" :span="2">
              {{ taskForm.baseInfo.personInChargeElectricCertificate }}
            </a-descriptions-item>
            <a-descriptions-item label="用电人">
              {{
                taskForm.measuresForm ? taskForm.measuresForm.powerConsumer : ""
              }}
            </a-descriptions-item>
          ...
          <h3 class="gasAnalysis">
            可燃气体分析（运行的生产装置、罐区和具有火灾爆炸危险场所）
          </h3>
          <div style="margin-top: 12px" v-if="taskSource.length !== 0">
            <a-table
              :scroll="{ x: 100 }"
              :pagination="false"
