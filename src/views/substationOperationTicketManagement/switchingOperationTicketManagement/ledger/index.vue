      ...
      >
        ...
        <template #footer>
          <div style="text-align: center">
            <a-button type="primary" @click="agreeClick" v-if="!checkForm"
              >同意</a-button
            >
            <a-button type="danger" @click="rejectClick" v-if="!checkForm"
              >驳回</a-button
            >
...
import { getListForShenHe, selectByID, deleteByIDShenHe, companySelect, applyAudio } from "@/api/substationOperationTicketManagement/switchingOperationTicketManagement.js"
export default {
  ...
  methods: {
    ...
    deleteClick() {
      if (this.selectedRowKeys.length > 0) {
        deleteByIDShenHe(this.selectedRowKeys).then((res) => {
          if (res.code == 200) {
