  ...
  <div class="job-ticket-approval">
    <a-form-model ref="formRef" :model="formModel" :rules="rules">
      ...
      <a-row>
        ...
        <first-review
          :hiddenVisible="formModel.id ? true : false"
          v-if="$route.path == '/firstJobTicketApproval'"
          ref="firstReviewRef"
        ></first-review>
        <second-review
          :hiddenVisible="formModel.id ? true : false"
          v-if="$route.path == '/secondWorkTicketApproval'"
          ref="secondReviewRef"
        ></second-review>
      </a-row>
      <div v-if="checkForm">
...
import { insert, createNewId, update, applyAudio, companySelect, selectByID, applySubmit } from "@/api/substationOperationTicketManagement/jobTicketApply.js"
// import { getListForShenHe, companySelect, , deleteshenhe, applyAudio } from "@/api/substationOperationTicketManagement/jobTicketApply.js"

import Sortable from 'sortablejs'
export default {
  name: "jobTicketApproval",
  components: {
    firstReview,
    stepsModel,
    secondReview,
  ...
  methods: {
    ...
    approvalMethod(type) {
      if (this.$route.path == '/firstJobTicketApproval') {
