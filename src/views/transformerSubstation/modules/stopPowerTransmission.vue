...
export default {
  ...
  methods: {
    ...
    viewJump(row) {
      ...
      this.getDetailsList(row);
      this.typeModel = "view";
      this.addTitle = "停送电申请-详情";
    },
    addClick() {
      this.addTitle = "停送电申请-新增";
      this.typeModel = "add";
    ...
    // async deleteRightClick(row) {
    //   debugger
    //   const rowId = row.id;
    //   const res = await deleteBatch([rowId]);
    //   if (res.code === "true") {
