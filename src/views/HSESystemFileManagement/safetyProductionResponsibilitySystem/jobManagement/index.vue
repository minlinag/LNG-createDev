      ...
      <pe-button
        :include="[
          ...
          { value: 'Delete', clickName: 'deleteClick' },
          {
            ...
            isPower: false,
            url: 'PostManagement/downloadTemplate',
          },
          {
            value: 'importComponent',
            url: '/PostManagement/importExcel',
            accept: '.xlsx',
          ...
          },
          {
            ...
            isPower: false,
            name: '导出',
            url: 'PostManagement/exportExcelAJob',
            params: {
...
import { postManagementFindAllList, postManagementQueryByID, postManagementDeleteBatch } from "@/api/HSESystemFileManagement/safetyProductionResponsibilitySystem"
export default {
