...
import { personnelExamineFindAllList, personnelExamineQueryByID, personnelExamineDeleteBatch } from "@/api/HSESystemFileManagement/departmentalResponsibilitySystemAssessment"
...
export default {
  ...
  methods: {
    ...
    // },
    addClick() {
      this.formTitle = "部门责任制考核-新增";
      this.checkForm = false;
      this.isAssessment = false
      this.hiddenVisible = true;
    },
    assessmentClick(row) {
      this.formTitle = "部门责任制考核-考核";
      this.checkForm = false;
