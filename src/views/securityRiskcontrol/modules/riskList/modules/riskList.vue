      ...
      <pe-button
        :include="[
          ...
          },
          {
            ...
            params: {
              areaName:
                this.form.areaName == undefined ? '' : this.form.areaName,
              unitName: this.form.unitName,
              responsibleUnit:
                this.form.responsibleUnit == undefined
                  ? ''
                  : this.form.responsibleUnit,
              responsibleUser: this.form.responsibleUser,
              riskRateLevel:
                this.form.riskRateLevel == undefined
                  ? ''
                  : this.form.riskRateLevel,
            },
          },
        ]"
    ...
    <template slot="appMain">
      ...
      >
        <a-form-model
          ...
          <a-row>
            <a-col :span="12">
              <a-form-model-item label="填报人" prop="remark">
                <a-input
  ...
  methods: {
    ...
    handleChange(val) {
      this.areaList.forEach(item => {
        console.log(item);
        if (item.descinfo == val) {
          this.riskLibraryForm.areaCode = item.dictcode
        }
      })
    },
    getdict() {
