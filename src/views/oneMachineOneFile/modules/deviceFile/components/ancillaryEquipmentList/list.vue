...
import {
  findAllList,
  deleteBatch,
  accessoryEquipmentTableControllerAdd,
  accessoryEquipmentTableControllerUpdate,
} from '@/api/oneMachineOneFile/ancillaryEquipmentList'
...
export default {
  ...
  methods: {
    ...
    submitForm(val) {
      if (val.id) {
        accessoryEquipmentTableControllerUpdate(val).then((res) => {
          if (res.code == 200) {
        ...
        accessoryEquipmentTableControllerAdd(val).then((res) => {
          if (res.code == 200) {
