              ...
              <div id="printContent">
                ...
                <table class="table_form" width="100%" border="2">
                  ...
                  <tr style="height: 25px">
                    <td width="10%">日期</td>
                    <td width="18%">生活用电量<br />(kw.h)</td>
                    <td width="18%">生产用电量<br />(kw.h)</td>
                    <td width="18%">其他用电量<br />(kw.h)</td>
                    <td width="18%">合计量<br />(kw.h)</td>
                    <td width="18%">备注</td>
                  </tr>
                  <tr
...
import {
  ...
  submit,
  approval,
} from "@/api/energyManagement/energyStatistics/electricMonthlyRecord.js";
  ...
  methods: {
    ...
    getDailyList(beginDate, endDate, type) {
      ...
      queryDailyData(searchForm).then((res) => {
        if (res.body) {
          this.dailyDataSource = res.body.eleDailyDataDtoList;
          ...
          if (!type) {
            ...
            this.reportData.otherConsumption = res.body.otherConsumption;
          ...
          delete this.reportData.otherConsumption;
    ...
    addClick() {
      this.pageType = "add";
      this.modelConfig.title = "耗电统计月报-新增";
      //生成编号
      let reportCode = "HDTJYB" + this.formatDate(new Date(), "yyyyMMddHHmmss");
    ...
    editClick(val) {
      this.pageType = "edit";
      this.modelConfig.title = "耗电统计月报-编辑";
      this.visible = true;
      this.reportData = {
        id: val.id,
        //报表年YYYY
    ...
    lookClick(val) {
      this.pageType = "look";
      this.modelConfig.title = "耗电统计月报-详情";
      this.visible = true;
      this.reportData = {
        id: val.id,
        //报表年YYYY
