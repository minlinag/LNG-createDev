    ...
    <Breadcrumb>
      ...
      <template slot="appMain">
        ...
        <a-modal
          ...
          :width="950"
          @cancel="dealWithCancel"
          :footer="null"
          class="from-style middleModel"
        >
          <processe-application-form
            @close="dealWithCancel"
            :addvisible="dealWithVisible"
...
import processeApplicationForm from "./processeApplicationForm.vue";
export default {
  components: { detailsForm, processeApplicationForm },
  name: "",
  // 临时
  // components:{},
  // props:{},
