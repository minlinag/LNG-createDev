  ...
  <div>
    ...
    >
      <a-form-model ref="detailForm" :model="detailForm">
        ...
        <stepsModel
          ref="stepsModel"
          :isShow="typeModel.type === 'edit' ? true : false"
          :id="detailForm.id"
...
import { approval as disApproval } from '@/api/equipmentMaintenance/equipmentDismantleMgt/equipmentDismantleMgt.js'
import { approval as scrApproval } from '@/api/equipmentMaintenance/equipmentScrapMgt/equipmentScrapMgt.js'
export default {
  name: 'detailModel',
