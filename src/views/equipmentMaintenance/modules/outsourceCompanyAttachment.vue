      ...
      >
        ...
        >
          <template slot="upload">
            <importConpontsData @fileChange="flieChange"></importConpontsData>
          </template>
        </FormitemDemo>
      </dc-Model>
    </template>
...
export default {
  ...
  methods: {
    ...
    changeCode(value) {
      ...
      if (value.formKey == 'startDate') {
        var startSj = +new Date(value.value)
        // console.log(start)
        if (value.formKey == 'endDate') {
          var endSj = +new Date(value.value)
          console.log(endSj)    
